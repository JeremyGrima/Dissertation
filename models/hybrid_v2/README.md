...
Run `train_merl_classifier.py` as described in `HOW TO RUN.md` to regenerate both files. The SHA-256 checksum of the privately archived fitted model is recorded in `run_configuration.json` for audit comparison.
